...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.backgroundColor = [UIColor colorWithRed:100.0f / 255.0f green:100.0f / 255.0f blue:100.0f / 255.0f alpha:0.1f]; //[UIColor clearColor];
...
- (void)updateIndicators {
	...
	if (mode == MBProgressHUDModeIndeterminate &&  !isActivityIndicator) {
        ...
        [(UIActivityIndicatorView *)indicator setColor:[UIColor grayColor]];
...
- (void)layoutSubviews {
    ...
    labelSize.width = MAX(labelSize.width, 80);
